...
* **Consul**: For all the [ports used by Consul](https://www.consul.io/docs/agent/options.html#ports), you can
  use the `allowed_inbound_cidr_blocks` and `allowed_inbound_ipv6_cidr_blocks` parameters to control the list of
...
* **SSH**: For the SSH port (default: 22), you can use the `allowed_ssh_cidr_blocks` and `allowed_ssh_ipv6_cidr_blocks` parameters to control the list of
